'use strict';
// Central Bank of Iraq exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/cbiq';
...
/** Latest rate for one pair, e.g. getRate('USD', 'IQD', { apiKey }). */
